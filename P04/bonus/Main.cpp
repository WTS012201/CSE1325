...
int main(){
    ...
    myDeck -> add_card("Bundling data and code into a restricted container? ","Encapsulation", "It encapsulates data and code");
    myDeck -> add_card("A data type consisting of a fixed set of constant values called enumerators? ","Enumerated type", "It consists of enumerators");
    ...
    myDeck -> add_card("A special class member that cleans up when an object is deleted? ","Destructor", "It destructs an object");
    ...
    myDeck -> add_card("The class inheriting members? ","Derived Class", "It derives memebers from a base class");
